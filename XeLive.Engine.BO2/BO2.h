...
#define colorBlue               Vector4(112, 224, 0, 255)
...
static DWORD(__cdecl *R_TextWidth)(int A1, CONST PCHAR Text, DWORD MaxCharacters, DWORD Font);
static void(_cdecl *R_AddCmdDrawText)(char* text, int maxChars, int font, float x, float y, float xScale, float yScale, float rotation, Vector4& color, int style);
static VOID(__cdecl *CL_DrawTextPhysical)(CONST PCHAR Text, DWORD MaxCharacters, DWORD Font, FLOAT X, FLOAT Y, FLOAT XScale, FLOAT YScale, FLOAT Angle, Vector4& Color, DWORD Style);
static VOID(__cdecl *R_AddCmdDrawStretchPic)(FLOAT X, FLOAT Y, FLOAT W, FLOAT H, FLOAT XScale, FLOAT YScale, FLOAT Xay, FLOAT Yay, Vector4& Color, DWORD Material);
static VOID(__cdecl* CG_DrawRotatedPicPhysical)(DWORD ScreenPlacement, FLOAT X, FLOAT Y, FLOAT Width, FLOAT Height, FLOAT Angle, Vector4& Color, DWORD Material);
